  ...
  uk: [
    {
      ...
      body: 'Сьогодні Олексій керує невеликою кавʼярнею в Ірпені, виховує доньку та раз на місяць приходить підтримати інших — тих, хто тільки починає свою дорогу назад. Ми не кажемо, що було легко. Ми кажемо, що поруч був хтось, хто знав шлях.',
      name: 'Олексій Я.',
  ...
  en: [
    {
      ...
      body: "Today Oleksii runs a small café in Irpin, raises his daughter, and once a month comes back to support others — those just starting their road home. We don't say it was easy. We say someone who knew the way was right beside him.",
      name: 'Oleksii Ya.',
    ...
    },
    {
      ...
      body: "Mariia's husband came back from the front, but home stayed unfamiliar for a long time. Together with the therapists of \"Road\", she learned to listen — and to speak. Today Mariia coordinates meetings of veterans' wives in Kyiv.",
      name: 'Mariia K.',
    ...
    },
    {
      ...
      body: 'Bohdan tried on his own — without success. The lawyer of "Road" sorted everything in two weeks. "He just sat next to me and said: we will sign this together," he recalls. Today Bohdan helps others on the same path.',
      name: 'Bohdan S.',
    ...
    },
    {
      ...
      body: "They said — you'll know what to do next. For the first time in a long while, that gave Vitalii ground to stand on. Today he works as an instructor and helps younger comrades find their way after returning.",
      name: 'Vitalii P.',
